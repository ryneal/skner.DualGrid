...
namespace skner.DualGrid.Utils
{
    ...
    public static class HexDualGridUtils
    {
        ...
        // Render tilemap positioning is no longer expressed as a cell-local anchor.
        // HexDualGridTilemapModule.AlignRenderTilemaps derives the world-space offset
        // for each render tilemap directly from the grid geometry (the centroid of the
        // three data-hex centers a render cell maps to), which is correct for both
        // orientations and any cell size. See that method for details.
